              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () async {
                      final result =
                          await Navigator.pushNamed(context, '/vendasCriar');
                      if (result == 'created') {
                        _refreshVendas();
                      }
                    },
        ...
        if (snapshot.connectionState == ConnectionState.waiting) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              if (venda.codigoDesconto != null &&
                  venda.codigoDesconto!.isNotEmpty) {
                valorComDesconto =
                    aplicarDesconto(venda.precoTotal, venda.codigoDesconto!);
              }
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                          'Funcionário: ${venda.funcionario?.nome ?? "Não disponível"}',
                          style: AppStyles.listItemSubtitleStyle),
                      Text(
                          'Cliente: ${venda.cliente?.nome ?? "Não disponível"}',
                          style: AppStyles.listItemSubtitleStyle),
                      Text(
                          'Preço Total: R\$ ${venda.precoTotal.toStringAsFixed(2)}',
                          style: AppStyles.listItemSubtitleStyle),
                      if (venda.codigoDesconto !=
                          null) // Exibe o valor com desconto se houver
                        Text(
                            'Preço com Desconto: R\$ ${valorComDesconto.toStringAsFixed(2)}',
                            style: AppStyles.listItemSubtitleStyle),
                      Text('Parcelas: ${venda.parcelas ?? 'Não disponível'}',
                          style: AppStyles.listItemSubtitleStyle),
                      Text(
                          'Preço Parcelado: R\$ ${venda.precoParcelado ?? 'Não disponível'}',
                          style: AppStyles.listItemSubtitleStyle),
                      Text(
